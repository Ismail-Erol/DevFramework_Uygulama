...
namespace DevFramework.Core.Aspects.Postsharp.PerformanceAspects
{
    ...
    public class PerformanceCounterAspect : OnMethodBoundaryAspect
    {
        ...
        public PerformanceCounterAspect(int interval=5) // buradaki 5 saniye default değeri farklı methodlarda değiştriebiliriz. 
        {
            _interval = interval;
        }
        ...
        public override void OnExit(MethodExecutionArgs args)
        {
            ...
            {
                // bu kısımda ister loglarız ister mail atarız fark etmez. kendi iş ihtiyaçlarımıza göre burayı düzenleyebiliriz. 
